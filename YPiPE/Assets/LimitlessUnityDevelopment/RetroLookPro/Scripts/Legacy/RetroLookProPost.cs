...
if (turnAllEffectsOff) return;
            ...
            if (!referenceScr && developmentMode)
            {
                ...
                return;
                        ...
                        if (!referenceScr && developmentMode)
            {
                Graphics.Blit(myRenderTexture, myRenderTexture);
                return;
            }
            T += Time.deltaTime;
            if (T > 100) T = 0;
            ...
            if (tempPreset.enableCustomTexture)
            {
                ...
                if (tempPreset.bypassTex != null) Graphics.Blit(tempPreset.bypassTex, myRenderTexture, tempPreset.m_1);
            ...
            if (tempPreset.useBottomNoise || tempPreset.useBottomStretch)
            {
                ...
                Graphics.Blit(myRenderTexture, texBottomNoise, tempPreset._bottomNoiseMat);
            }else{
                Graphics.Blit(myRenderTexture, texBottomNoise);
            }
            #endregion
            ...
            if (fcount % 13 == 0) Graphics.Blit(myRenderTexture, _trashFrame1);
            if (fcount % 73 == 0) Graphics.Blit(myRenderTexture, _trashFrame2);
            ...
            {
                Graphics.Blit(texNeg, myRenderTexture, tempPreset.m_2);
            }
            else
            {
